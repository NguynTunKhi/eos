...
function download_file(el){
    ...
    var request_create_station_id = $('#hf-request-create-station-id').val()
    var folder = $('#m-folder').val()
    window.location = `/eos/${url}?filename=${filename}&request_create_station_id=${request_create_station_id}&folder=${folder}`
}
...
function load_table() {
    ...
    var options = $.extend(tb_options, {
        ...
        fnServerData: function(sSource, aoData, fnCallback) {
            aoData.push({name: "request_create_station_id", value: request_create_station_id})
