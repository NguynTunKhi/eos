...
function changeConnectionLoss() {
    $('#cbbConnectionLoss').on('change', function () {
        ...
        switch (connection_loss) {
            case '3':
                $('table tr:first th:nth-child(2)').text('Số lần gián đoạn truyền dữ liệu ≥3h');
                break;
            case '12':
                $('table tr:first th:nth-child(2)').text('Số lần gián đoạn truyền dữ liệu ≥12h');
                break;
            case '24':
                $('table tr:first th:nth-child(2)').text('Số lần gián đoạn truyền dữ liệu ≥24h');
                break;
            case '48':
                $('table tr:first th:nth-child(2)').text('Số lần gián đoạn truyền dữ liệu ≥48h');
                break;
            default:
                $('table tr:first th:nth-child(2)').text('Số lần gián đoạn truyền dữ liệu');
        }
    });
}
...
function loadDataTableForPage() {
    ...
    var aoClass = ['', 'text-left',  'text-center'];
    loadDataTable({
