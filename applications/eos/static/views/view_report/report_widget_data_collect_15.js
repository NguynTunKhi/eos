...
$(document).ready(function () {
    ...
    $('#cbbArea').change(function () {
     ...
     $('#cbbDateType').on('change', function (e) {
        switch ($('#cbbDateType').val()) {
            case "quarter":
                $('table tr:first th:nth-child(3)').text("Quý này");
                $('table tr:first th:nth-child(4)').text("Quý trước");
                break;
            case "year":
                $('table tr:first th:nth-child(3)').text("Năm này");
                $('table tr:first th:nth-child(4)').text("Năm trước");
                break
            default:
                $('table tr:first th:nth-child(3)').text("Tháng này");
                $('table tr:first th:nth-child(4)').text("Tháng trước");
        }
    });
