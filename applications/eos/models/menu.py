...
# Description : 
#
# from applications.eos.models.js_languages import vn
...
if defaultLang == None or defaultLang == 'vn-vi':
    from applications.eos.models.js_languages import vn
    response.js_string = vn.JS_LANGUAGES
elif defaultLang == 'us-en':
    from applications.eos.models.js_languages import en
    response.js_string = en.JS_LANGUAGES
